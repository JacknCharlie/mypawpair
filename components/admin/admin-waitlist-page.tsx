                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-white bg-[#F3B443] rounded-xl hover:transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        style={FONT}
                      >
                        {sending === w.email ? (
                          <>
