        ...
        <div className="bg-white rounded-2xl p-12 border border-gray-100 shadow-sm flex flex-col items-center text-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm" style={{ fontFamily: "Inter, sans-serif" }}>
              Add your dog first to see care provider matches
            </p>
          </div>
    ...
    <div className="flex flex-col gap-6">
      ...
      <div>
        ...
        <p className="text-gray-500 text-[16px] mt-1" style={{ fontFamily: "Inter, sans-serif" }}>
          Care providers matched to your dog based on compatibility
        </p>
      </div>
        ...
        <div className="bg-white rounded-2xl p-12 border border-gray-100 shadow-sm flex flex-col items-center text-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm max-w-sm" style={{ fontFamily: "Inter, sans-serif" }}>
              Matches are generated by our team once enough care providers are in your area. Check back soon!
            </p>
          </div>
        </div>
      )}
      ...
      {matches && matches.length > 0 && (
        <div className="flex flex-col gap-4">
          {matches.map((match) => {
            ...
            const name = caregiver.profiles?.full_name ?? "Care provider";
